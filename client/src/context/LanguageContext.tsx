...
const translations: Record<string, Record<Language, string>> = {
  ...
  'dashboard.collectionRate': { en: 'Collection Rate', es: 'Tasa de Cobranza' },
  'dashboard.clientsInRed': { en: 'Clients in Arrears', es: 'Clientes en Rojo' },
  'dashboard.daysLate': { en: '{days} days late', es: '{days} días de atraso' },
  'dashboard.earlyPayment': { en: 'On time', es: 'A tiempo' },
  'dashboard.latePayment': { en: 'Overdue', es: 'Vencida' },
  'dashboard.seeAllPayments': { en: 'See all payments', es: 'Ver todos los pagos' },
  'dashboard.monthlyCollection': { en: 'Collection Over Time', es: 'Cobranza en el Tiempo' },
  'dashboard.thisWeek': { en: 'This week', es: 'Esta semana' },
  'dashboard.installmentOf': { en: 'Installment {n}/{total}', es: 'Cuota {n}/{total}' },
  'dashboard.registerPayment': { en: 'Register Payment', es: 'Registrar Pago' },
  'dashboard.noClientsInRed': { en: 'No clients with arrears', es: 'Sin clientes en rojo' },
  'dashboard.vsPrevious': { en: 'vs previous period', es: 'vs período anterior' },
  'dashboard.collected': { en: 'Collected', es: 'Cobrado' },
  // Clients
  ...
  'clientDetail.totalBorrowed': { en: 'Total Lent', es: 'Total Prestado' },
  'clientDetail.totalCollected': { en: 'Total Collected', es: 'Total Cobrado' },
  'clientDetail.debtArs': { en: 'Debt ARS', es: 'Deuda ARS' },
  'clientDetail.debtUsd': { en: 'Debt USD', es: 'Deuda USD' },
  'clientDetail.clientSince': { en: 'Client Since', es: 'Cliente Desde' },
  'clientDetail.overdueAlert': { en: 'This client has overdue credits', es: 'Este cliente tiene créditos vencidos' },
  'clientDetail.dueSoonAlert': { en: 'Credit due {days} day(s)', es: 'Crédito vence en {days} día(s)' },
  'clientDetail.dueToday': { en: 'Due today', es: 'Vence hoy' },
  'clientDetail.dueTomorrow': { en: 'Due tomorrow', es: 'Vence mañana' },
  'clientDetail.installmentProgress': { en: '{paid}/{total} paid', es: '{paid}/{total} pagas' },
  'clientDetail.daysRemaining': { en: 'Due in {days} day(s)', es: 'Vence en {days} día(s)' },
  'clientDetail.overdueDays': { en: 'Overdue {days} day(s)', es: 'Vencido hace {days} día(s)' },
  'clientDetail.registerPayment': { en: 'Register Payment', es: 'Registrar Pago' },
  'clientDetail.recentActivity': { en: 'Recent Activity', es: 'Actividad Reciente' },
  'clientDetail.noRecentActivity': { en: 'No recent payments', es: 'Sin pagos recientes' },
  'clientDetail.amount': { en: 'Amount', es: 'Monto' },
  'clientDetail.date': { en: 'Date', es: 'Fecha' },
  'clientDetail.credit': { en: 'Credit', es: 'Crédito' },
  // Create Client
  ...
  'credits.search': { en: 'Search by client...', es: 'Buscar por cliente...' },
  'credits.filterAll': { en: 'All', es: 'Todos' },
  'credits.filterActive': { en: 'Active', es: 'Activo' },
  'credits.filterOverdue': { en: 'Overdue', es: 'Vencido' },
  'credits.filterPaid': { en: 'Paid', es: 'Pagado' },
  'credits.overdueDays': { en: 'Overdue {days} day(s)', es: 'Vencido hace {days} día(s)' },
  'credits.installmentProgress': { en: '{paid}/{total} installments paid', es: '{paid}/{total} cuotas pagas' },
  'credits.summaryActive': { en: 'Active', es: 'Activos' },
  'credits.summaryOverdue': { en: 'Overdue', es: 'Vencidos' },
  'credits.pendingVsOriginal': { en: 'Pending: {currency} {balance} / {amount}', es: 'Pendiente: {currency} {balance} / {amount}' },
  'credits.registerPayment': { en: 'Register Payment', es: 'Registrar Pago' },
  // Credit Detail
  ...
  'payments.registerPayment': { en: 'Register Payment', es: 'Registrar Pago' },
  'payments.searchPlaceholder': { en: 'Search by client name...', es: 'Buscar por cliente...' },
  'payments.errorLoad': { en: 'Error loading payments', es: 'Error al cargar pagos' },
  'payments.successRegister': { en: 'Payment registered successfully', es: 'Pago registrado correctamente' },
  'payments.successVoid': { en: 'Payment voided successfully', es: 'Pago anulado correctamente' },
  'payments.errorVoid': { en: 'Error voiding payment', es: 'Error al anular pago' },
  'payments.viewCredit': { en: 'View credit', es: 'Ver crédito' },
  'payments.viewClient': { en: 'View client', es: 'Ver cliente' },
  'payments.viewDetail': { en: 'View detail', es: 'Ver detalle' },
  'payments.void': { en: 'Void', es: 'Anular' },
  'payments.voidConfirmTitle': { en: 'Void Payment', es: 'Anular Pago' },
  'payments.voidConfirmMessage': { en: 'This will void the payment and revert the credit balance. Continue?', es: 'Esto anulará el pago y revertirá el saldo del crédito. ¿Continuar?' },
  'payments.voidConfirm': { en: 'Void', es: 'Anular' },
  'payments.installmentOf': { en: 'Installment {n}/{total}', es: 'Cuota {n}/{total}' },
  'payments.pendingBefore': { en: 'Pending before', es: 'Pendiente antes' },
  // Payment Stats
  'payments.stats.totalArs': { en: 'Total ARS', es: 'Total ARS' },
  'payments.stats.totalUsd': { en: 'Total USD', es: 'Total USD' },
  'payments.stats.paymentCount': { en: 'Payments', es: 'Pagos' },
  'payments.stats.clientCount': { en: 'Clients', es: 'Clientes' },
  'payments.stats.overdue': { en: 'Overdue', es: 'Vencidos' },
  // Payment Methods
  'payments.method.cash': { en: 'Cash', es: 'Efectivo' },
  'payments.method.transfer': { en: 'Transfer', es: 'Transferencia' },
  'payments.method.debitCard': { en: 'Debit Card', es: 'Débito' },
  'payments.method.creditCard': { en: 'Credit Card', es: 'Crédito' },
  'payments.method.other': { en: 'Other', es: 'Otro' },
  // Payment Status
  'payments.status.onTime': { en: 'On time', es: 'A tiempo' },
  'payments.status.late': { en: 'Late', es: 'Con atraso' },
  'payments.status.lateDays': { en: '{days} days late', es: '{days} días de atraso' },
  'payments.status.early': { en: 'Early', es: 'Adelantado' },
  'payments.status.paid': { en: 'Paid', es: 'Pagado' },
  'payments.status.cancelled': { en: 'Cancelled', es: 'Cancelado' },
  // Payment Filters
  'payments.filter.allCurrencies': { en: 'All currencies', es: 'Todas las monedas' },
  'payments.filter.allMethods': { en: 'All methods', es: 'Todos los métodos' },
  'payments.filter.allStatuses': { en: 'All statuses', es: 'Todos los estados' },
  'payments.filter.from': { en: 'From', es: 'Desde' },
  'payments.filter.to': { en: 'To', es: 'Hasta' },
  'payments.filter.clear': { en: 'Clear filters', es: 'Limpiar filtros' },
  // Payment Sort
  'payments.sort.date': { en: 'Date', es: 'Fecha' },
  'payments.sort.amount': { en: 'Amount', es: 'Monto' },
  'payments.sort.client': { en: 'Client', es: 'Cliente' },
  'payments.sort.asc': { en: 'Ascending', es: 'Ascendente' },
  'payments.sort.desc': { en: 'Descending', es: 'Descendente' },
  // Payment Pagination
  'payments.pagination.showing': { en: 'Showing {start}-{end} of {total} payments', es: 'Mostrando {start}-{end} de {total} pagos' },
  // Register Modal
  'payments.register.title': { en: 'Register Payment', es: 'Registrar Pago' },
  'payments.register.selectCredit': { en: 'Select a credit', es: 'Seleccionar crédito' },
  'payments.register.amount': { en: 'Amount *', es: 'Monto *' },
  'payments.register.method': { en: 'Method', es: 'Método' },
  'payments.register.date': { en: 'Date', es: 'Fecha' },
  'payments.register.note': { en: 'Note', es: 'Nota' },
  'payments.register.notePlaceholder': { en: 'Optional note...', es: 'Nota opcional...' },
  'payments.register.client': { en: 'Client', es: 'Cliente' },
  'payments.register.total': { en: 'Total', es: 'Total' },
  'payments.register.balance': { en: 'Balance', es: 'Saldo' },
  'payments.register.invalidAmount': { en: 'Please enter a valid amount', es: 'Ingresa un monto válido' },
  'payments.register.exceedsBalance': { en: 'Amount exceeds remaining balance', es: 'El monto supera el saldo pendiente' },
  'payments.register.submit': { en: 'Register', es: 'Registrar' },
  'payments.register.submitting': { en: 'Registering...', es: 'Registrando...' },
  'payments.register.cancel': { en: 'Cancel', es: 'Cancelar' },
  'payments.register.error': { en: 'Error registering payment', es: 'Error al registrar pago' },
  // Activity
